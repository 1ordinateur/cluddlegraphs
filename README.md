...
- **Local graph navigation**: Opens ordinary, Ctrl-click, and Cmd-click file nodes from a local graph directly in the most recently used main editor pane instead of replacing the active graph or sidebar pane, while preserving native Shift/Alt-click and tag behavior.
